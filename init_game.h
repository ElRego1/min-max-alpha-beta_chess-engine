...
std::vector<std::vector<char>> make_board_matrix(char &collor) {
...
make_print_board_matrix(char &collor) {
	std::vector<std::vector<std::vector<char>>> p(BOX_LENGTH, 
		std::vector<std::vector<char>>(BOX_LENGTH, std::vector<char>(3,0)));
